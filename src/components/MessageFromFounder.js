...
const MessageFromFounder = () => {
  return (
    <div className="font-poppins px-10 ">
      <p className="flex justify-center text-xl lg:text-3xl font-semibold text-[#FD6B75] xl:my-10">
      ...
      <div className="md:flex w-full">
        ...
        <div className="flex flex-col items-center justify-center my-6 md:w-1/3">
          ...
          <div className="flex justify-between gap-6 mt-4">
            ...
            <img src="/images/icons/instagram-logo.png" className="w-6"></img>
            </Link>
            <Link to={'https://www.linkedin.com/in/anju-dinesh-08252422/'}>
            <img src="/images/icons/linkedin-logo.png" className="w-6"></img>
            </Link>
          </div>
        </div>
        {/* founder message */}
        <div className="my-4 md:w-2/3">
          <p className="text-xs md:text-sm xl:text-[17px] text-[#FD6B75] font-light text-center">"
            ...
            size, deserves top-tier HR support.</p> <p className="mt-3 text-xs md:text-sm xl:text-[17px] text-[#FD6B75] font-light text-center">We also understand that many
            ...
            potential of their teams.</p> <p className="mt-3 text-xs md:text-sm xl:text-[17px] text-[#FD6B75] font-light text-center"> At Phenomenal HR, we firmly believe that
            ...
            have on cultivating high-performance work cultures.</p> <p className="mt-3 text-xs md:text-sm xl:text-[17px] text-[#FD6B75] font-light text-center"> Whether you're a
            ...
            organization.</p> <p className="mt-3 text-xs md:text-sm xl:text-[17px] text-[#FD6B75] font-light text-center"> Together, let's unlock the full potential of your
