    ...
    <div className="font-poppins px-10 ">
      ...
      <div className="md:flex w-full">
        ...
        <div className="my-4 md:w-2/3">
          <p className="text-xs md:text-sm xl:text-[17px] text-[#00B8A2] font-light text-center">"
            ...
            size, deserves top-tier HR support.</p> <p className="mt-3 text-xs md:text-sm xl:text-[17px] text-[#00B8A2] font-light text-center">We also understand that many
            ...
            potential of their teams.</p> <p className="mt-3 text-xs md:text-sm xl:text-[17px] text-[#00B8A2] font-light text-center"> At Phenomenal HR, we firmly believe that
            ...
            have on cultivating high-performance work cultures.</p> <p className="mt-3 text-xs md:text-sm xl:text-[17px] text-[#00B8A2] font-light text-center"> Whether you're a
            ...
            organization.</p> <p className="mt-3 text-xs md:text-sm xl:text-[17px] text-[#00B8A2] font-light text-center"> Together, let's unlock the full potential of your
